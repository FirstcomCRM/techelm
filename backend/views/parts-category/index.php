    ...
    $gridColumns = [
        ...
        [
            ...
            'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'preview') {
                    $url ='?r=parts-category/view&id='.$model->id;
                    return $url;
                }   
                if ($action === 'update') {
                    $url ='?r=parts-category/update&id='.$model->id;
                    return $url;
                }
                if ($action === 'delete') {
                    $url ='?r=parts-category/delete-column&id='.$model->id;
                    return $url;
                }
            }
        ],
...
<div class="row parts-category-index">

    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="fa fa-cogs"></i> <?= Html::encode($this->title) ?> </h2>

                <div class="box-icon">
                    <a href="?r=parts-category/create" class="btn btn-round btn-default">
