...
$this->title = 'Designated Position List';
    ...
    $gridColumns = [
        ...
        [
            ...
            'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'preview') {
                    $url ='?r=designated-position/view&id='.$model->id;
                    return $url;
                }   
                if ($action === 'update') {
                    $url ='?r=designated-position/update&id='.$model->id;
                    return $url;
                }
                if ($action === 'delete') {
                    $url ='?r=designated-position/delete-column&id='.$model->id;
                    return $url;
                }
            }
        ],
...
<div class="row designated-position-index">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                ...
                <div class="box-icon">
                    <a href="?r=designated-position/create" class="btn btn-round btn-default">
