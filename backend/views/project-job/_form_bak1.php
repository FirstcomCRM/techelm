...
<div class="project-job-form">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-3">
                    <?php $form->field($model, 'first_inspector')->dropDownList($Inspectors) ?>
                </div>
                <div class="col-md-3">
                    <?php $form->field($model, 'second_inspector')->dropDownList($Inspectors) ?>
                </div>
                <div class="col-md-3">
                   <?php $form->field($model, 'third_inspector')->dropDownList($Inspectors) ?>
                </div>
                <div class="col-md-3">
                    <?php $form->field($model, 'status_flag')->dropDownList($Status, ['required'=> '']) ?>
                </div>
            </div>
        </div>
    </div>
