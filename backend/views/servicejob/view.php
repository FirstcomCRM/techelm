...
<div class="servicejob-view">
    ...
    <p class="text-right">
      ...
      <?php Html::a('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Firebase Testing', ['test', 'id' => $model->id], ['class' => 'btn btn-primary','target'=>'_blank']) ?>

      <?php Html::a('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Mobile Email', ['mobile-email', 'id' => $model->id], ['class' => 'btn btn-primary','target'=>'_blank']) ?>
      <?php Html::a('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> Mobile View', ['mobile-page', 'id' => $model->id], ['class' => 'btn btn-primary','target'=>'_blank']) ?>
        ...
        <?php if ($model->status == 3): ?>
            <?= Html::a('<i class="fa fa-file-pdf-o" aria-hidden="true"></i> View PDF', ['pdf-jobs', 'id' => $model->id], ['class' => 'btn btn-primary','target'=>'_blank']) ?>
        <?php else: ?>
