...
/* @var $searchModel common\models\SearchTaskCategory */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Task Category';
    ...
    $gridColumns = [
        ...
        [
            ...
            'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'preview') {
                    $url ='?r=task-category/view&id='.$model->id;
                    return $url;
                }   
                if ($action === 'update') {
                    $url ='?r=task-category/update&id='.$model->id;
                    return $url;
                }
                if ($action === 'delete') {
                    $url ='?r=task-category/delete-column&id='.$model->id;
                    return $url;
                }
            }
        ],
...
<div class="row task-category-index">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                ...
                <div class="box-icon">
                    <a href="?r=task-category/create" class="btn btn-round btn-default">
