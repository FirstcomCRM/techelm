...
<div class="projectjob-piss-tasks-form">
     <div class="row">
         <div class="col-md-2 pull-right">
             <?= $form->field($model, 'projectjob_id')->dropDownList($projectjob_id, ['required'=> '']); ?>
         </div>
     </div>
                 ...
                 <table id="task" class="table table-responsive table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> <?= $form->field($model, 'drawing_before[]')->fileInput(['multiple' => false, 'accept' => 'image/*'])->label(false) ?></td>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-2 end">
                        ...
                        <?= Html::submitButton('<i class="fa fa-plus" aria-hidden="true"></i>  Add Row', ['id'=> 'adds_row','class' =>  'btn btn-primary']) ?>
                    </div>
