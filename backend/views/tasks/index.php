...
/* @var $searchModel common\models\SearchTasks */
    ...
    $gridColumns = [
        ...
        [
            ...
            'urlCreator' => function ($action, $model, $key, $index) {
                if ($action === 'preview') {
                    $url ='?r=tasks/view&id='.$model->id;
                    return $url;
                }
                if ($action === 'update') {
                    $url ='?r=tasks/update&id='.$model->id;
                    return $url;
                }
                if ($action === 'delete') {
                    $url ='?r=tasks/delete-column&id='.$model->id;
                    return $url;
                }
            }
        ],
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                ...
                <div class="box-icon">
                    <a href="?r=tasks/create" class="btn btn-round btn-default">
