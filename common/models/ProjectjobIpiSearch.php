...
/**
 * ProjectjobIpiSearch represents the model behind the search form about `common\models\ProjectjobIpi`.
 */
class ProjectjobIpiSearch extends ProjectjobIpi
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'projectjob_id', 'dispo_by_date', 'status'], 'integer'],
            [['sub_contractor', 'disposition_by', 'sub_c_signature', 'dispo_by_siganture', 'sub_c_date', 'date_inspected', 'form_type'], 'safe'],
        ];
    }
