...
class SearchParts extends Parts
{
    ...
    {
        return [
            [['id', 'parts_category_id', 'quantity', 'status', 'created_by', 'updated_by'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'parts_code', $this->parts_code])
            ->andFilterWhere(['like', 'parts_name', $this->parts_name])
